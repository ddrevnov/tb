...
var _index = require('./modules/client/Booking/index');

var _index2 = _interopRequireDefault(_index);

var _index3 = require('./modules/client/Guestbook/index');

var _index4 = _interopRequireDefault(_index3);

var _index5 = require('./modules/client/Auth/index');

var _index6 = _interopRequireDefault(_index5);

require('./modules/client/Registration/index');
...
$(document).ready(function () {
    ...
    var vm = new _vue2.default({
        el: 'body',
        components: {
            Guestbook: _index4.default,
            Booking: _index2.default,
            Auth: _index6.default
        },
...
},{"./i18n/datepicker-de":6,"./modules/client/Auth/index":8,"./modules/client/Booking/index":9,"./modules/client/Guestbook/index":13,"./modules/client/Registration/index":14,"vue":3}],6:[function(require,module,exports){
"use strict";
...
var RestoreForm = _vue2.default.component('authForm', {
    ...
    watch: {
        'restoreEmail': function restoreEmail(val, oldVal) {
    ...
    methods: {
        ...
        showRestoreForm: function showRestoreForm() {
            this.showRestore = true;
            this.showLogin = false;
        },
        hideRestoreForm: function hideRestoreForm() {
            if (vm.restoringPass) {
                return false;
            }
            this.restoreEmail = '';
...
var Auth = _vue2.default.component('auth', {
    components: {
        authFom: _authForm2.default
    }
});

exports.default = Auth;

},{"./authForm":7,"vue":3}],9:[function(require,module,exports){
'use strict';
...
var Booking = _vue2.default.component('booking', {
    components: {
        tabs: _tabs2.default
    }
});
...
},{"./tabs":10,"vue":3}],10:[function(require,module,exports){
'use strict';
...
var Tabs = _vue2.default.component('tabs', {
    template: '#tabs-tpl',
    data: function data() {
        return {
            times: [],
    ...
    ready: function ready() {
        vm = this;
        vm.setWorkTimes().then(vm.setDom).then(vm.checkAuth);
    },
    watch: {
        'order.timeFrom': function orderTimeFrom(val, oldVal) {
            if (val !== '' && val !== oldVal) {
                if (vm.orderIsFormed) {
        ...
        'order.date': function orderDate(val, oldVal) {
        ...
        'order.employeeId': function orderEmployeeId(currentId, prevId) {
            if (currentId !== prevId) {
                if (vm.orderIsFormed) {
        ...
        'order.serviceId': function orderServiceId(val, oldVal) {
            if (vm.orderIsFormed) {
        ...
        'activeTab': function activeTab(currentTab, prevTab) {
            switch (currentTab) {
                case 2:
    ...
    methods: {
        setOrderTime: function setOrderTime(time, e) {
            var $el = $(e.target);
            ...
            vm.bookingTabs.tabs({
                ...
                activate: function activate(event, ui) {
                    ...
                    if (newIndex > oldIndex) {
                        ...
                        for (var _i = newIndex + 1; _i <= oldIndex; _i++) {
                            if (_i !== 0) {
                                $(arr[_i]).removeClass('ui-tabs-active');
                            }
                        }
                    }
                }
        ...
        fetchServices: function fetchServices(data) {
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
        ...
        checkEmployeeByTime: function checkEmployeeByTime() {
        ...
        showSelectedEmployees: function showSelectedEmployees() {
        ...
        toNextTab: function toNextTab() {
            ...
            vm.bookingTabs.tabs('enable', vm.activeTab).tabs("option", "active", vm.activeTab);
        },
        toBook: function toBook(e) {
            if (!vm.isLogin) {
                e.preventDefault();
        ...
        selectEmployee: function selectEmployee(e) {
        ...
        showBusyTimeAlert: function showBusyTimeAlert() {
        ...
        checkDayByWorkTimes: function checkDayByWorkTimes(day) {
            var result;
        ...
        checkGuest: function checkGuest() {
        ...
        setWorkTimes: function setWorkTimes() {
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
        ...
        setMinMaxTimeByDay: function setMinMaxTimeByDay() {
...
var Comment = _vue2.default.component('comment', {
    props: ['data', 'userId'],
    data: function data() {
        return {
    ...
    watch: {
        'editableComment.stars': function editableCommentStars(val, oldVal) {
    ...
    methods: {
        showEditForm: function showEditForm(id, event) {
            this.editableComment = _vue2.default.util.extend({}, this.comment);
        ...
        cancelComment: function cancelComment(id, event) {
            this.showEditableForm = false;
        },
        isMyComment: function isMyComment() {
...
_vue2.default.use(window["VueValidator"]);

var CommentForm = _vue2.default.component('commentForm', {
...
var Guestbook = _vue2.default.component('guestbook', {
    components: {
...
},{"./comment":11,"./commentForm":12,"vue":3}],14:[function(require,module,exports){
'use strict';
...
_vue2.default.component('registration', _registration2.default);

},{"./registration.vue":15,"vue":3}],15:[function(require,module,exports){
...
exports.default = {
    ...
    methods: {
        ...
        showEmailError: function showEmailError() {
            ...
            this.sending = false;
            this.$setValidationErrors([{ field: 'email' }]);
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<validator name=\"validation\">\n    <form @submit.prevent=\"signUp\" class=\"login-form\" id=\"clientRegistration\" novalidate=\"\">\n        <fieldset>\n            <input class=\"login-form__input\" type=\"email\" v-model=\"email\" v-validate:email=\"{required: true, email: true}\" detect-change=\"on\" :classes=\"{\n                    dirty: 'dirty-reg-email', invalid: 'invalid-reg-email',\n                    valid: 'valid-reg-email', pristine: 'pristine-reg-email'}\" name=\"email\" placeholder=\"E-Mail\">\n            <span class=\"validation-icon\"></span>\n\n            <p class=\"validation-msg__email-exist\" v-if=\"isEmailExist\">Benutzer mit dieser E-Mail ist bereits vorhanden. Bitte geben Sie eine andere\n                E-Mail.</p>\n        </fieldset>\n\n        <fieldset>\n            <input class=\"login-form__input\" type=\"text\" v-model=\"phone\" name=\"telephone\" placeholder=\"Telefonnummer\">\n        </fieldset>\n\n        <fieldset>\n            <input class=\"login-form__input\" type=\"text\" v-model=\"mobile\" name=\"mobile\" placeholder=\"Handy-Nummer\">\n        </fieldset>\n\n        <fieldset>\n            <input class=\"login-form__input\" type=\"text\" v-model=\"firstName\" v-validate:first-name=\"{required: true}\" detect-change=\"on\" detect-blur=\"off\" :classes=\"{\n                   dirty: 'dirty-reg-firstname', invalid: 'invalid-reg-firstname',\n                    valid: 'valid-reg-firstname', pristine: 'pristine-reg-firstname'}\" name=\"first_name\" placeholder=\"Vorname\">\n            <span class=\"validation-icon\"></span>\n        </fieldset>\n\n        <fieldset>\n            <input class=\"login-form__input\" type=\"text\" v-model=\"lastName\" v-validate:last-name=\"['required']\" detect-change=\"on\" detect-blur=\"off\" :classes=\"{\n                   dirty: 'dirty-reg-lastname', invalid: 'invalid-reg-lastname',\n                    valid: 'valid-reg-lastname', pristine: 'pristine-reg-lastname'}\" name=\"last_name\" placeholder=\"Nachname\">\n            <span class=\"validation-icon\"></span>\n        </fieldset>\n\n        <fieldset>\n            <input class=\"login-form__input\" id=\"birthday\" type=\"text\" v-model=\"birthday\" name=\"birthday\" placeholder=\"Geburtstag\">\n        </fieldset>\n\n        <fieldset>\n            <select name=\"gender\" class=\"login-form__input\" v-model=\"gender\">\n                <option value=\"male\">Male</option>\n                <option value=\"female\">Weiblich</option>\n                <option value=\"\" disabled=\"\" selected=\"\" class=\"gender_display\">Geschlecht</option>\n            </select>\n        </fieldset>\n\n        <input class=\"login-form__submit\" type=\"submit\" value=\"Registrieren\" :disabled=\"sending\">\n    </form>\n</validator>\n"
