	...
	<div class="gwa-popup-inner"<?php echo !empty( $_POST['maxwidth'] ) && $_POST['maxwidth'] != 'auto' ? sprintf( ' style="width:%dpx;"', (int)$_POST['maxwidth'] ) : ''; ?>>
		...
		<div class="gwa-popup-content-wrap">
			<div class="gwa-popup-content">			
				<iframe class="gwa-popup-iframe" src="<?php echo esc_attr_e( add_query_arg( array( 'id' => (int)$_POST['data'],  'nonce' => wp_create_nonce( $this->plugin_base .'-preview' ) ), $this->plugin_url . 'includes/preview.php' ) ) ; ?>"></iframe>
