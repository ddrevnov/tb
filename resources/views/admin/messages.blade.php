...
@section('content')
    ...
    <section class="director-nachrichten director-main">
        ...
        <h1 class="heading heading__h1">{{trans_choice('common.messages', 2)}}</h1>
        ...
        <div class="director-content">
            ...
            <div class="block">
                ...
                <ul class="block__nav">
                    <li data-tab="tab-1" class="block__item is-active">{{trans('messages.entrance')}}</li>
                </ul>
        ...
        <section class="eingang">
            <div class="contacts">
                <input
                        ...
                        class="eingang__search textSearchvalue_h" type="search" placeholder="{{trans('messages.search')}}" autofocus>
