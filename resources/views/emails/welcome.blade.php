...
<div style="width: 629px; background: #ffffff; border: 1px solid #e9e9e9; border-top: 0px solid; padding: 15px 35px;">
  ...
  <div style="margin-bottom: 30px;">
      <p style="margin: 0px;">Sehr geehrte <strong>Frau {{isset($firstname) ? $firstname : $name}} {{$lastname}},</strong></p>
  ...
  <div style="margin-bottom: 60px;">
    <p>Bei Fragen zu Ihrem Account können Sie sich gerne jederzeit an uns wenden.“</p>
  </div>
