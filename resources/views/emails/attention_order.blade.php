...
<div style="width: 699px; background: #ffffff; border: 1px solid #e9e9e9;">
    <img src="http://tb.hqsale.com/wp/wp-content/themes/bootstrap-basic/img/logo.jpg" alt="timebox24"
...
<div style="width: 629px; background: #ffffff; border: 1px solid #e9e9e9; border-top: 0px solid; padding: 15px 35px;">
    ...
    <div style="margin-bottom: 30px;">
        ...
        <h1 style="font-size: 22px;">@lang('emails.message_attention_order', ['firstname' => $firstname], $locale)</h1>
